 ...
 *
 * <p>Resolves the country by traversing: m_client → m_selfservice_office_address → m_address →
 * m_code_value. Returns an empty string for any missing link rather than throwing, as the country
...
public class SelfServiceOfficeAddressReadServiceImpl
    implements SelfServiceOfficeAddressReadService {
  ...
  public String retrieveOfficeCountryByClientId(final Long clientId) {
    ...
    try {
      ...
      log.debug(
          "No active office address with country found for clientId={}; returning empty", clientId);
      return "";
