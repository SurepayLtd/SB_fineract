...
public class SelfSavingsAccountApiResource {
  ...
  public SavingsAccountData retrieveSavings(
    ...
    SavingsAccountData savingsAccountData = this.savingsAccountReadPlatformService.retrieveOne(accountId);
    final Collection<SavingsAccountTransactionData> transactions = this.savingsAccountReadPlatformService
        .retrieveAllTransactions(accountId, org.apache.fineract.portfolio.savings.DepositAccountType.SAVINGS_DEPOSIT);
    savingsAccountData = SavingsAccountData.withTemplateOptions(savingsAccountData, null, transactions, savingsAccountData.getCharges());
