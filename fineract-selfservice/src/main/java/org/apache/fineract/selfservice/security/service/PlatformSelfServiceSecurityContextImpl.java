 ...
 *
 * <p>Implements both {@link PlatformSelfServiceSecurityContext} (for self-service API resources)
 * and {@link PlatformSecurityContext} (for core read services that call {@code
 * context.authenticatedUser()} as a guard check).
 *
 * <p>Uses native permission validation methods from {@link AppSelfServiceUser} so self-service
