...
public class ExecuteStandingInstructionsConfig {
    ...
    @Autowired
    private StandingInstructionHistoryWriteService standingInstructionHistoryWriteService;
    ...
    public ExecuteStandingInstructionsTasklet executeStandingInstructionsTasklet() {
        return new ExecuteStandingInstructionsTasklet(standingInstructionReadPlatformService, standingInstructionHistoryWriteService);
    }
}
